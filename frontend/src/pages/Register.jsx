...
const Register = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-slate-50 p-4">
      <div className="w-full max-w-md bg-white border border-slate-200 rounded-2xl shadow-xl p-8 my-8">
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-slate-900 tracking-wide">Join InsuraX</h2>
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          ...
          <div>
            ...
            <select
              ...
              value={formData.role}
              onChange={handleChange}
              className="block w-full px-3 py-2.5 bg-white border border-slate-300 rounded-lg text-slate-900 focus:outline-none focus:ring-2 focus:ring-sky-500/50 focus:border-sky-500 transition-colors"
            >
